...
(`tt.horner.tj` by default), which receives it with your IP address, like any
website you visit. Transit Thing does not store your location, collects nothing
else, and has no analytics.
